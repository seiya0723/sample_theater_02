...
SECRET_KEY = 'django-insecure-it5s*#z16scwy=nmd18qlz2g3ijsd+!wd=pl!5i_g=5z4+t(v#'
...
MIDDLEWARE = [
    ...
    #'review.middleware.sidebar.SimpleMiddleware',
]
...
#TODO:herokuデプロイ時にSTATICFILES_DIRSを指定しているとエラーが出るため
if DEBUG:
